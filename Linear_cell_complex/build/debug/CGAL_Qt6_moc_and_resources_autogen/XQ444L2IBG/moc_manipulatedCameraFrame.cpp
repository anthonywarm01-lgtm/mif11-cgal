...
#include <memory>
#include "../../../../../../../GraphicsView/include/CGAL/Qt/manipulatedCameraFrame.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CGAL__qglviewer__ManipulatedCameraFrame_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CGAL__qglviewer__ManipulatedCameraFrame_t qt_meta_stringdata_CGAL__qglviewer__ManipulatedCameraFrame = {
    {
        QT_MOC_LITERAL(0, 39),  // "CGAL::qglviewer::ManipulatedC..."
        QT_MOC_LITERAL(40, 11),  // "setFlySpeed"
        QT_MOC_LITERAL(52, 0),  // ""
        QT_MOC_LITERAL(53, 5),  // "speed"
        QT_MOC_LITERAL(59, 16),  // "setSceneUpVector"
        QT_MOC_LITERAL(76, 3),  // "Vec"
        QT_MOC_LITERAL(80, 2),  // "up"
        QT_MOC_LITERAL(83, 4),  // "spin"
        QT_MOC_LITERAL(88, 9)   // "flyUpdate"
    },
...
Q_CONSTINIT static const uint qt_meta_data_CGAL__qglviewer__ManipulatedCameraFrame[] = {
...
Q_CONSTINIT const QMetaObject CGAL::qglviewer::ManipulatedCameraFrame::staticMetaObject = { {
    ...
    qt_meta_stringdata_CGAL__qglviewer__ManipulatedCameraFrame.offsetsAndSizes,
    qt_meta_data_CGAL__qglviewer__ManipulatedCameraFrame,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CGAL__qglviewer__ManipulatedCameraFrame_t,
        // Q_OBJECT / Q_GADGET
